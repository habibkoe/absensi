...
const AppLayout = ({ children, headMenu }: Props) => {
  ...
  if (loading) {
    return (
      <div className="w-full h-screen px-1 pt-16 md:px-5 flex justify-center items-center">
  ...
  return authorized ? (
    <Flowbite theme={{ theme: customTheme }}>
      <MainNavbar />
      <div className="w-full h-screen px-1 pt-16 md:px-5">
        <Card className="w-full xl:w-3/6 dark:bg-[#242526] mx-auto dark:border-[#242526] bg-white border-gray-100">
          <div className="w-full">
            <div className="flex justify-between">
              <h5 className="text-xl tracking-tight dark:text-[#DADCE1] text-gray-900">
                {headMenu}
              </h5>
            </div>
          </div>
  ...
  textInput: {
    field: {
      ...
      input: {
        ...
        colors: {
          gray: "bg-gray-200 text-gray-800 dark:bg-[#3A3B3C] dark:border-gray-300 border-gray-500 dark:text-gray-300 focus:border-orange-400 focus:ring-orange-400 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500",
          graySave:
            "bg-[#1f2020] border-gray-700 text-gray-300 focus:border-orange-400 focus:ring-orange-400 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500",
  ...
  select: {
    field: {
      ...
      select: {
        ...
        colors: {
          gray: "border-gray-500 bg-gray-200 text-gray-800 dark:bg-[#3A3B3C] dark:border-gray-300 dark:text-gray-300 focus:border-orange-400 focus:ring-orange-400 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500",
          graySave:
            "bg-[#1f2020] border-gray-700 text-gray-300 focus:border-orange-400 focus:ring-orange-400 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500",
          info: "border-cyan-500 bg-cyan-50 text-cyan-900 placeholder-cyan-700 focus:border-cyan-500 focus:ring-cyan-500 dark:border-cyan-400 dark:bg-cyan-100 dark:focus:border-cyan-500 dark:focus:ring-cyan-500",
          failure:
  ...
  datepicker: {
      root: {
        ...
        input: {
          ...
          field: {
            input: {
              base: "rounded-lg overflow-hidden block w-full border py-2 disabled:cursor-not-allowed disabled:opacity-50",
              sizes: {
                sm: "sm:text-xs",
                md: "text-sm",
                lg: "sm:text-md",
