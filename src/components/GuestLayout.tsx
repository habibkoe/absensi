  ...
  textInput: {
    field: {
      ...
      input: {
        ...
        colors: {
          gray: "bg-[#272728] border-[#272728] text-gray-300 focus:border-cyan-500 focus:ring-cyan-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500",
